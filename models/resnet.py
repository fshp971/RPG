...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_dims, out_dims, wide=1, down_sampling=False):
...
def WRN50_2(in_dims, out_dims, down_sampling=False):
    return ResNet(Bottleneck, [3,4,6,3], in_dims, out_dims, wide=2)
